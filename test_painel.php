        ...
        <div id="block1">
            <form id="form1" name="pesquisapassagem" action="passagens.php" method="post">
             <div id="op_basica">    
                ...
                <label for="origem">Origem</label><input type="text" size="30" name="origem" value="" ></input>
                <label for="destino">Destino</label><input type="text" size="30" name="destino" value="" ></input><br />
                <div id="op_basica_idavolta">
                  <p><label for="data1">Ida</label><!-- data 1 -->
             ...
             <div id="save_opv">
                 ...
                 <p id="op_avancada_fecha"><a>&lt;&lt; Opções avançadas</a></p>
             </div>
             <div id="pesquisar">
