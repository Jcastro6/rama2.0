...
<title>Rama - Administração</title>
...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><img src="images/shared/logo_rama.png" width="160" height="60" alt="Rama" /></a>
	</div>
	<!-- end logo -->
...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="#nogo"><b>Passagens</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li><a href="#nogo">View all Bilhetes</a></li>
				<li class="sub_show"><a href="#nogo">Add bilhetes</a></li>
				<li><a href="#nogo">Delete bilhetes</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
...
<tr>
	...
	<td>
		...
		<tr>
         ...
         <tr>
   			<th valign="top">Data ida:</th>
			<td><input type="text" class="inp-form" /></td>
         </tr>
         <tr>
   			<th valign="top">Data volta:</th>
			<td><input type="text" class="inp-form" /></td>
		</tr>
		<tr>
...
<div id="footer">
	<!--  start footer-left -->
	<div id="footer-left">
	Admin Rama &copy; Copyright Rama Viagens e Turismo Ltd. <a href="">www.ramaViagens.com</a>. All rights reserved.</div>
	<!--  end footer-left -->
	<div class="clear">&nbsp;</div>
</div>
<!-- end footer -->
